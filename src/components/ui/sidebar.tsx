...
>(({ className, onClick, ...props }, ref) => {
  ...
  return (
    <Button
      ...
      {...props}
    >
      <ViewVerticalIcon className={className} />
  ...
  return (
    <button
      ...
      className={cn(
        ...
        // "shadow-right-only after:content-none before:content-none after:border-none before:border-none", 
        className
      )}
      {...props}
    />
